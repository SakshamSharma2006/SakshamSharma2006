...
<!--
  ...
  of profiles hit it). Two reliable fixes:
  1. Deploy your own free instance: fork https://github.com/anuraghazra/github-readme-stats
     and deploy to Vercel in ~2 minutes, then swap the domain in the URLs above to yours.
  2. Wait and retry — GitHub caches the raw README, so a broken image can also just be
